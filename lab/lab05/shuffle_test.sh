...
#Evaluation criteria
# Runs the shuffle.pl file 1000 times and records the output. Counts for omissions, repetitions or incorrect values. Selects 4 random values and checks for their occurrence. In an iteration of 1000 each value should occur at roughly (1/10)*1000 positions. Hence a raw entropy range of 80 to 120 inclusive. 
